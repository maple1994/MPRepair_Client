...
// DateLabel选中时的背景色
#define MSS_SelectBackgroundColor [UIColor colorWithRed:247/255.0 green:86/255.0 blue:88/255.0 alpha:1]
// DateLabel选中后文字颜色
#define MSS_SelectTextColor [UIColor whiteColor]
// SubLabel文字颜色
#define MSS_SelectSubLabelTextColor [UIColor blackColor]
// SubLabel选中开始文字
...
// 周末颜色
#define MSS_WeekEndTextColor [UIColor blackColor]
// 不可点击文字颜色
